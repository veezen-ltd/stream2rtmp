...
namespace  veezen{
    ...
    private:
        std::shared_ptr<Client<veezen::STREAM, veezen::STREAM, veezen::TOKEN>> client;
    public:
        explicit RsocketConnectionEventHandler(std::shared_ptr<Client<veezen::STREAM, veezen::STREAM, veezen::TOKEN>> client)
        {
